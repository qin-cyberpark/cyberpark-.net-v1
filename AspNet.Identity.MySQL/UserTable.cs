...
namespace AspNet.Identity.MySQL
{
        ...
        where TUser :IdentityUser
    {
        ...
        /// <summary>
        /// Returns a list of TUser instances given a user name or email
        /// </summary>
        /// <param name="userNameOrEmail">User's name or email</param>
        /// <returns></returns>
        public List<TUser> GetUserByNameOrEmail(string userNameOrEmail)
        {
            List<TUser> users = new List<TUser>();
            string commandText = "Select * from Users where UserName = @userNameOrEmail or Email = @userNameOrEmail";
            Dictionary<string, object> parameters = new Dictionary<string, object>() { { "@userNameOrEmail", userNameOrEmail } };
        ...
        public List<TUser> GetUserByPhoneOrEmail(string phoneOrEmail)
        {
            List<TUser> users = new List<TUser>();
            string commandText = "Select * from Users where PhoneNumber = @phoneOrEmail or Email = @phoneOrEmail";
            Dictionary<string, object> parameters = new Dictionary<string, object>() { { "@phoneOrEmail", phoneOrEmail } };
